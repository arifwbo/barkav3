...
<?php else: ?>
    ...
    <meta property="og:title" content="<?= isset($page_title) ? $page_title . ' | ' : '' ?><?= __session('school_name') ?>" />
    <meta property="og:description" content="<?= __session('meta_description') ?>" />
    <meta property="og:image" content="<?= base_url('media_library/images/'. __session('logo')) ?>" />
<?php endif ?>

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="<?= isset($page_title) ? $page_title . ' | ' : '' ?><?= __session('school_name') ?>" />
<meta name="twitter:description" content="<?= __session('meta_description') ?>" />
<meta name="twitter:image" content="<?= base_url('media_library/images/'. __session('logo')) ?>" />
